...
def train_model():
    ...
    torch.save(model.cuda().state_dict(),
               'pre_model/UID2021_SOTA_IQA_Meta_UIQASFTNet.pt')
...
def load_data(mod='train', dataset='UID2021', worker_idx=0):
    ...
    if mod == 'train':
        ...
        dataloader_train = DataLoader(transformed_dataset_train, batch_size=12,
                                      shuffle=True, num_workers=4, collate_fn=my_collate)
        dataloader_valid = DataLoader(transformed_dataset_valid, batch_size=12,
        ...
        transformed_dataset_valid_1 = ImageRatingsDataset(csv_file=cross_data_path,
                                                          ...
                                                          transform=test_transforms)
        dataloader_train = 0
        dataloader_valid = DataLoader(transformed_dataset_valid_1, batch_size=12,
                                      shuffle=False, num_workers=4, collate_fn=my_collate)

...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.norm4 = norm_layer(self.num_features)
        self.norm5 = norm_layer(self.num_features)
        ##########
    ...
    def forward(self,x, x1,x2,x3):
        ...
        x1 = self.norm2(x1)  # B L C
       
        x2 = self.norm3(x2)  # B L C
        
        
        x3 = self.norm4(x3)  # B L C
        
        
        #x4 = self.norm5(x4)  # B L C

...
def computeSpearman(dataloader_valid, model):
    ...
    # 保存到csv文件
    #    output_file = os.path.join(output_folder, 'output_UIED_9.csv')
...
def finetune_model():
    ...
    data_dir = os.path.join('/home/user/Database/UIED')
    ...
    images_fold = "/home/user/Database/UIED/"
    ...
    for i in range(0,10):
        ...
        for epoch in range(epochs):
            ...
            #with open('eachEpochResult_UIED.txt', 'a') as f1:  # 设置文件对象data.txt
